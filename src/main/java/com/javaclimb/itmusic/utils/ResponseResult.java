package com.javaclimb.itmusic.utils;
...
public class ResponseResult<T> {
    ...
    public static <T> ResponseResult<T> success() {
        return response(HttpCodeEnum.SUCCESS.getCode(), true, HttpCodeEnum.SUCCESS.getMessage(), null);
    }
     ...
     * @return {@link ResponseResult<T>}
     */
    public static <T> ResponseResult<T> success(HttpCodeEnum httpResponseEnum) {
    ...
    public static <T> ResponseResult<T> success(String message, T data) {
        return response(HttpCodeEnum.SUCCESS.getCode(), true, message, data);
    }
    ...
    public static <T> ResponseResult<T> success(T data) {
        return response(HttpCodeEnum.SUCCESS.getCode(), true, HttpCodeEnum.SUCCESS.getMessage(), data);
    }
    ...
    public static <T> ResponseResult<T> success(String message) {
        return response(HttpCodeEnum.SUCCESS.getCode(), true, message, null);
    }
    ...
    public static <T> ResponseResult<T> fail() {
        return response(HttpCodeEnum.ERROR.getCode(), false, HttpCodeEnum.ERROR.getMessage(), null);
    }
     ...
     * @return {@link ResponseResult<T>}
     */
    public static <T> ResponseResult<T> fail(HttpCodeEnum httpResponseEnum) {
    ...
    public static <T> ResponseResult<T> fail(String message, T data) {
        return response(HttpCodeEnum.ERROR.getCode(), false, message, data);
    }
    ...
    public static <T> ResponseResult<T> fail(T data) {
        return response(HttpCodeEnum.ERROR.getCode(), false, HttpCodeEnum.ERROR.getMessage(), data);
    }
    ...
    public static <T> ResponseResult<T> fail(String message) {
        return response(HttpCodeEnum.ERROR.getCode(), false, message, null);
    }
}